 ...
 */
  JNIEXPORT jstring JNICALL Java_edu_cs300_MessageJNI_readStringMsg(JNIEnv *, jclass);
 ...
 */
  JNIEXPORT jobject JNICALL Java_edu_cs300_MessageJNI_readPrefixRequestMsg(JNIEnv *, jclass);
 ...
 */
  JNIEXPORT void JNICALL Java_edu_cs300_MessageJNI_writeLongestWordResponseMsg(JNIEnv *, jclass, jint, jstring, jint, jstring, jstring, jint, jint);
